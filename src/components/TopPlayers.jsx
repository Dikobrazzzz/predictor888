        ...
        <>
          ...
          <div style={{ width: '100%', borderRadius: '24px', padding: '15px', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', border: '1px solid transparent', background: 'linear-gradient(#1A1A1A, #1A1A1A) padding-box, linear-gradient(180deg, rgba(160,160,160,0.15) 0%, rgba(211,211,211,0) 100%) border-box' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', margin: '0 -15px 0', padding: '4px 15px', background: 'rgba(0,0,0,0.20)', height: '40px' }}>
              <span style={{ flex: 1, color: 'rgba(255,255,255,0.42)', fontSize: '12px', fontWeight: 400 }}>Match</span>
              <span style={{ width: '40px', textAlign: 'center', color: 'rgba(255,255,255,0.42)', fontSize: '12px', fontWeight: 400 }}>Pick</span>
              <span style={{ width: '50px', textAlign: 'right', color: 'rgba(255,255,255,0.42)', fontSize: '12px', fontWeight: 400, marginRight: '4px' }}>XP</span>
              <span style={{ width: '48px', textAlign: 'right', color: 'rgba(255,255,255,0.42)', fontSize: '12px', fontWeight: 400 }}>Status</span>
            </div>
